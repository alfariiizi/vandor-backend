...
func RegenerateServicesGo() error {
	...
	buf.WriteString("// Template: https://github.com/alfariiizi/go-service.\n")
	buf.WriteString("package service\n\n")
	buf.WriteString("import (\n\t\"go.uber.org/fx\"\n")
	for group := range groupStructMap {
		buf.WriteString(fmt.Sprintf("\t%s_service \"github.com/alfariiizi/go-service/internal/core/service/%s\"\n", group, group))
	}
	buf.WriteString(")\n\n")
