...
// NumberOfUses applies equality check predicate on the "number_of_uses" field. It's identical to NumberOfUsesEQ.
func NumberOfUses(v uint64) predicate.Session {
	return predicate.Session(sql.FieldEQ(FieldNumberOfUses, v))
}
...
// NumberOfUsesEQ applies the EQ predicate on the "number_of_uses" field.
func NumberOfUsesEQ(v uint64) predicate.Session {
	return predicate.Session(sql.FieldEQ(FieldNumberOfUses, v))
}

// NumberOfUsesNEQ applies the NEQ predicate on the "number_of_uses" field.
func NumberOfUsesNEQ(v uint64) predicate.Session {
	return predicate.Session(sql.FieldNEQ(FieldNumberOfUses, v))
}

// NumberOfUsesIn applies the In predicate on the "number_of_uses" field.
func NumberOfUsesIn(vs ...uint64) predicate.Session {
	return predicate.Session(sql.FieldIn(FieldNumberOfUses, vs...))
}

// NumberOfUsesNotIn applies the NotIn predicate on the "number_of_uses" field.
func NumberOfUsesNotIn(vs ...uint64) predicate.Session {
	return predicate.Session(sql.FieldNotIn(FieldNumberOfUses, vs...))
}

// NumberOfUsesGT applies the GT predicate on the "number_of_uses" field.
func NumberOfUsesGT(v uint64) predicate.Session {
	return predicate.Session(sql.FieldGT(FieldNumberOfUses, v))
}

// NumberOfUsesGTE applies the GTE predicate on the "number_of_uses" field.
func NumberOfUsesGTE(v uint64) predicate.Session {
	return predicate.Session(sql.FieldGTE(FieldNumberOfUses, v))
}

// NumberOfUsesLT applies the LT predicate on the "number_of_uses" field.
func NumberOfUsesLT(v uint64) predicate.Session {
	return predicate.Session(sql.FieldLT(FieldNumberOfUses, v))
}

// NumberOfUsesLTE applies the LTE predicate on the "number_of_uses" field.
func NumberOfUsesLTE(v uint64) predicate.Session {
	return predicate.Session(sql.FieldLTE(FieldNumberOfUses, v))
}
